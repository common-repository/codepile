...
class CPTComments {
	public function __construct( $feature ) {
		...
		$container->add_fields( array(
			...
			// Post Types
			Field::make( 'multiselect', 'codepile-cpt-comments-post-types', __( 'Post Types', 'coodepile' ) )
			     ->set_default_value( 'base' )
			     ->set_options( 'get_post_types' )
			     ->set_help_text( __( 'Select post types to enable comments on.' ) ),
